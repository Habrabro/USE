...
class MeasurableLinearLayoutManager extends LinearLayoutManager {
    private static final int SMOOTH_VALUE = 100;

    MeasurableLinearLayoutManager(Context context) {
        super(context);
    ...
    public int computeVerticalScrollRange(RecyclerView.State state) {
        return Math.max((getItemCount() + 2) * SMOOTH_VALUE, 0);
    }
