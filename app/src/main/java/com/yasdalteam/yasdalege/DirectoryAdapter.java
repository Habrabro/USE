...
public class DirectoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position)
    {
        ...
        switch (type)
        {
            case LIST_ITEM:
                ...
                break;
            case DIRECTORY_TOPIC:
                ((DirectoryTopic)holder).bind(directory);
                break;
        }
    }
    ...
    class DirectoryTopic extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        {
            fragmentDirectoryTitle.setText(directory.getTitle());
            DirectoryParser directoryParser = new DirectoryParser((LinearLayout)view);
